...
int main(int argc, char **argv)
{
	...
	printf("zone_reset_rewrite: total_lba=%lu zone_size_lba=%lu chunk_lba=%u open_zones=%d p1=%d p2=%d\n",
	       zopts.total_lba, zopts.zone_size_lba, zopts.chunk_lba, zopts.open_zones, zopts.pattern_id, pattern2);
